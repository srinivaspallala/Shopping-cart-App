...
for(let product of products){
    ...
    <option style="text-align:center" value="${product.id}">${product.title}</option>`
}
document.getElementById("content").onchange=(e)=>{

 let pinfo=products.find((prod)=>prod.id==e.target.value);
//  document.getElementById("box").innerHTML=pinfo;
    
 document.getElementById("box").innerHTML=`
 <div style="background-color:white;border:2px solid grey">
 <div><image src="${pinfo.image}" width="200px" height="200px"></div>
 <hr>
 ...
 <div><span style="font-size:20px;color:blue">Title:</span>
 ...
 text-align: center;"
><a class="add-cart" href="" onclick="cartNumbers()">Add to Cart</a></button>
 </div>
 </div>
 </div>`
}
...
function addToCartClicked(event){
    ...
    var shopitem=btnClicked.parentElement.parentElement.parentElement
    var title=shopitem.getElementsByClassName('title')[0].innerText
    // var category=shopitem.getElementsByClassName('catogery')[0].innerText
    var price=shopitem.getElementsByClassName('price')[0].innerText
    var imagesrc=shopitem.getElementsByClassName('image')[0].src
    console.log(title,price,imagesrc)
    // addItemToCart(title,price,imagesrc)
    document.querySelectorAll(".modaltitle").innerText=title
}
// function addItemToCart(title, price , imagesrc){
//     var cartRow=document.getElementsByClassName('add').innerText=title
//     // var cartRow=document.getElementsByClassName('modaltitle').innerHTML
//     // cartRow.innerText=title;
//     var cartItems=document.getElementsByClassName('card-deck')[0]
//     // var cartRowContents=`
//     // <div class="card  col-md-4">
//     //       <div class="card-body text-center">
//     //        <img class="image" src="https://fakestoreapi.com/img/71-3HjGNDUL._AC_SY879._SX._UX._SY._UY_.jpg" alt="" width="200px" height="250px">
//     //        <div class="card-text mt-3">
//     //         <span class="title">Mens Casual T-Shirts</span><br>
//     //         <span class="catogery">men's clothing</span><br>
//     //         <span class="price">$22.3</span><br>
